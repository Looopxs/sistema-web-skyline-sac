...
lines.forEach((line) => {
  ...
  if (parts.length >= 7) {
    ...
    if (category === 'Polos de Cuello') {
      ...
      if (cName.includes('rojo')) cssFilter = 'hue-rotate(-195deg) saturate(2)';
      else if (cName.includes('naranja')) cssFilter = 'hue-rotate(-165deg) saturate(2)';
      else if (cName.includes('amarillo') || cName.includes('dorado')) cssFilter = 'hue-rotate(-135deg) saturate(2) brightness(1.1)';
      else if (cName.includes('verde')) cssFilter = 'hue-rotate(-75deg) saturate(1.5)';
      else if (cName.includes('azul') && !cName.includes('oscuro')) cssFilter = 'hue-rotate(30deg) saturate(1.5)';
      else if (cName.includes('azul oscuro')) cssFilter = 'hue-rotate(45deg) saturate(1.5) brightness(0.6)';
      else if (cName.includes('morado')) cssFilter = 'hue-rotate(75deg) saturate(1.5)';
      else if (cName.includes('negro')) cssFilter = 'brightness(0.2)';
      else if (cName.includes('plomo')) cssFilter = 'saturate(0) brightness(0.8)';
      else if (cName.includes('blanco')) cssFilter = 'saturate(0) brightness(1.5)';
    }
